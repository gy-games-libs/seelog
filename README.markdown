...
[![Build Status](https://drone.io/github.com/gy-games-libs/seelog/status.png)](https://drone.io/github.com/gy-games-libs/seelog/latest)
...
* Different output writers
  ...
  * SMTP writer
  * Others... (See [Wiki](https://github.com/gy-games-libs/seelog/wiki))
...
import log "github.com/gy-games-libs/seelog"
...
```
go get -u github.com/gy-games-libs/seelog
```

*IMPORTANT*: If you are not using the latest release version of Go, check out this [wiki page](https://github.com/gy-games-libs/seelog/wiki/Notes-on-'go-get')

Documentation
---------------

Seelog has github wiki pages, which contain detailed how-tos references: https://github.com/gy-games-libs/seelog/wiki

Examples
---------------

Seelog examples can be found here: [seelog-examples](https://github.com/gy-games-libs/seelog-examples)

Issues
---------------

Feel free to push issues that could make Seelog better: https://github.com/gy-games-libs/seelog/issues
...
* **v2.6** : Config using code and custom formatters
    ...
    * Custom formatters. Check [wiki](https://github.com/gy-games-libs/seelog/wiki/Custom-formatters)
    * Bugfixes and internal improvements.
* **v2.5** : Interaction with other systems. Part 2: custom receivers
    * Finished custom receivers feature. Check [wiki](https://github.com/gy-games-libs/seelog/wiki/custom-receivers)
